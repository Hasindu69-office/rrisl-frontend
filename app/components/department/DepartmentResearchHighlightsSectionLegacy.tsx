...
export interface LegacyDepartmentResearchHighlightItem {
  id: string;
  text: string;
  imageSrc?: string;
  imageAlt?: string;
...
interface DepartmentResearchHighlightsSectionLegacyProps {
  tagText: string;
  titlePart1: string | React.ReactNode;
  titlePart2: string | React.ReactNode;
  backgroundImageSrc: string;
  backgroundImageAlt: string;
  highlights: LegacyDepartmentResearchHighlightItem[];
...
const resolveHighlightImage = (
  item: LegacyDepartmentResearchHighlightItem | undefined,
  fallbackSrc: string,
  fallbackAlt: string
): HighlightImageState => {
...
export default function DepartmentResearchHighlightsSectionLegacy({
  titlePart1,
  titlePart2,
  backgroundImageSrc,
  backgroundImageAlt,
  ...
  containerClassName = '',
}: DepartmentResearchHighlightsSectionLegacyProps) {
          ...
          <div className="flex min-h-[420px] flex-col p-6 md:h-screen md:min-h-[640px] md:justify-between md:p-10 lg:min-h-[760px] lg:p-12">
            ...
            >
              <div className="pointer-events-none flex items-center gap-2">
                <div className="rotate-180 overflow-visible whitespace-nowrap py-3 [writing-mode:vertical-rl]">
