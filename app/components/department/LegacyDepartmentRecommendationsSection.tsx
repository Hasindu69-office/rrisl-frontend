...
/**
 * Legacy promotional department recommendations section.
 * Kept for reference while the active department page uses the content-driven section.
 */
export default function LegacyDepartmentRecommendationsSection({
    tagText,
    titlePart1,
    titlePart2,
    description,
