    ...
    return (
        <section className="relative w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px] overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 w-full h-full">
                ...
                <div className="relative h-full w-full lg:w-[150%] z-20 overflow-hidden hidden lg:block">
                    <Image
                ...
                <div className="relative flex flex-col justify-center px-6 md:px-16 lg:px-24 py-12 lg:py-12 bg-transparent">
                    ...
                    <div className="absolute top-0 right-4 md:right-8 lg:right-36 select-none opacity-20 lg:opacity-30 pointer-events-none">
                        <svg
                            width="500"
                            height="150"
                            viewBox="0 0 500 150"
            ...
            {/* Middle Logo - Positioned at the center for desktop, hidden or repositioned for mobile */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-40 w-[120px] h-[120px] md:w-[150px] md:h-[150px] lg:w-[220px] lg:h-[220px] lg:flex items-center justify-center hidden">
                <Image
