  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden p-2 text-[#546F7A] hover:text-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 rounded-lg bg-white hover:bg-gray-50 transition-colors"
