...
export default function HeroSection({ hero }: HeroProps) {
  ...
  // Check for localhost in URLs (no need for window check - we're just checking the URL string)
  ...
  return (
    <>
      ...
      <section className="relative min-h-[600px] md:min-h-[700px] lg:min-h-[800px] flex items-center overflow-hidden z-10">
