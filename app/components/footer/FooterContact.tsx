...
export default function FooterContact({
  ...
  return (
    <div>
      ...
      <div className="mt-4 space-y-3 text-[12px] font-normal leading-relaxed text-white md:mt-6 md:space-y-4 md:text-[14px] md:leading-[28px] lg:mt-[30px] lg:text-[15px]">
        <div className="flex items-start gap-3">
          <div className="mt-1 flex-shrink-0">
            <svg width="20" height="20" className="md:h-6 md:w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-1 ml-8 md:ml-[36px]">
          <a href={`mailto:${email}`} className="text-white hover:text-[#A1DF0A]">
            {email}
          </a>
        </div>
      </div>
