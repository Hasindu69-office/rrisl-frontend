      ...
      {links.map((link, index) => {
        ...
        return (
          <a
            ...
            className="group relative flex h-[50px] w-[50px] md:h-[56px] md:w-[56px] lg:h-[66px] lg:w-[66px] items-center justify-center transition-transform transition-opacity duration-500 hover:opacity-90"
            style={{
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                maskImage: `radial-gradient(circle, transparent 24px, black 24px, black 25px, transparent 25px)`,
                WebkitMaskImage: `radial-gradient(circle, transparent 24px, black 24px, black 25px, transparent 25px)`,
              }}
            />
            {/* Desktop mask (original) */}
            <div
